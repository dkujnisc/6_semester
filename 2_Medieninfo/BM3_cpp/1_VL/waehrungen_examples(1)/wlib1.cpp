...
ClWaehrungGulden::ClWaehrungGulden(int ifl, int ix, int id)
{
fl=ifl;
x=ix;
d=id;
...
char *ClWaehrungGulden::asGulden(void)
{
sprintf(textg,"%d Gulden, %d Kreuzer, %d Pfennige",fl,x,d);
return textg;
}

char *ClWaehrungGulden::asTaler(void)
{
...
char *ClWaehrungTaler::asTaler(void)
{
sprintf(textt,"%d Taler, %d Silbergroschen, %d Pfennige",t,sgr,pf);
return textt;
}

char *ClWaehrungTaler::asGulden(void)
{
sprintf(textg,"%d Gulden, %d Kreuzer, %d Pfennige",fl,x,d);
return textg;
}
